...
fn main() {
    ...
    let api_host =
        env::var("OANDA_HOST").expect("expected OANDA_HOST environment variable to be set");
    ...
    match fxoanda::GetPositionBookRequest::new()
        .with_instrument("EUR_USD".to_string())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::GetOrderBookRequest::new()
        .with_instrument("EUR_USD".to_string())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListAccountsRequest::new().remote(&client) {
        Ok(x) => println!("OK: {:#?}", x),
        Err(e) => println!("ERR: {:#?}", e),
    }
    ...
    match fxoanda::GetAccountRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::GetAccountInstrumentsRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListOrdersRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListPendingOrdersRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListTradesRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListOpenTradesRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListPositionsRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListOpenPositionsRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
    ...
    match fxoanda::ListTransactionsRequest::new()
        .with_account_id(account_id.to_owned())
        .remote(&client)
    {
        Ok(x) => println!("OK: {:#?}", x),
